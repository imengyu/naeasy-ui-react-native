...
import { CellGroup, Cell, Popup, Iconfont, Color, Button, ColumnView } from 'imengyu-ui-lib';
      ...
      <ScrollView>
        <ColumnView center>
          ...
          <Popup
            ...
            renderContent={() => (
              <ColumnView center style={{ padding: 10 }}>
                <Iconfont icon="direction-up" color={Color.success} size={50} />
                <Text>底部弹出</Text>
              </ColumnView>
            )}
          />
          <Popup
            ...
            renderContent={() => (
              <ColumnView center style={{ padding: 10 }}>
                <Iconfont icon="direction-down" color={Color.success} size={50} />
                <Text>顶部弹出</Text>
              </ColumnView>
            )}
          />
          <Popup
            ...
            renderContent={() => (
              <ColumnView center style={{ padding: 10 }}>
                <Iconfont icon="direction-left" color={Color.success} size={50} />
                <Text>左侧弹出</Text>
              </ColumnView>
            )}
          />
          <Popup
            ...
            renderContent={() => (
              <ColumnView center style={{ padding: 10 }}>
                <Iconfont icon="direction-right" color={Color.success} size={50} />
                <Text>右侧弹出</Text>
              </ColumnView>
            )}
          />
