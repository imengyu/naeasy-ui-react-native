...
import { TabBar, TabBarItem } from 'imengyu-ui-lib';
import { RootStackParamList } from '../navigation';
import { Iconfont, Image } from 'imengyu-ui-lib';
        ...
        <ColumnView>
          ...
          >
            ...
            <TabBarItem name="hump"
              ...
              hump
              humpHeight={[ 50, 23 ]}
              renderIcon={(selected, iconProps) => selected ? <Image source={require('../images/test4.png')} style={styles.humpIcon} /> : <Iconfont { ...iconProps } />}
            />
            <TabBarItem name="third" icon="image-text" text="标签3" />
            <TabBarItem name="forth" icon="user" text="标签4" />
          </TabBar>
